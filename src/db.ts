/**
 * SQLite database access layer for the CNPD MCP server.
 *
 * Schema:
 *   - decisions    — CNPD decisions, sanctions, and délibérations
 *   - guidelines   — CNPD guidance documents, guides, and recommandations
