...
const TOOLS = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        query: { type: "string", description: "Search query in French (e.g., 'Amazon', 'sous-traitant', 'consentement')" },
        type: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "Get a specific CNPD decision by reference number.",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "CNPD decision reference" },
      },
      required: ["reference"],
    },
  },
  {
    ...
    description:
      "Search CNPD guidance documents: guides pratiques on vidéosurveillance, cookies, sous-traitance, transferts, and financial sector.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "Get a specific CNPD guidance document by its database ID.",
    inputSchema: {
      type: "object" as const,
      properties: {
