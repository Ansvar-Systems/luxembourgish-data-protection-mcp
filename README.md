...
[![npm version](https://badge.fury.io/js/%40ansvar%2Fluxembourgish-data-protection-mcp.svg)](https://www.npmjs.com/package/@ansvar/luxembourgish-data-protection-mcp)
[![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![CI](https://github.com/Ansvar-Systems/luxembourgish-data-protection-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/Ansvar-Systems/luxembourgish-data-protection-mcp/actions/workflows/ci.yml)
...
**Endpoint:** `https://mcp.ansvar.eu/luxembourgish-data-protection/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add luxembourgish-data-protection-mcp --transport http https://mcp.ansvar.eu/luxembourgish-data-protection/mcp` |
...
```json
{
  "mcpServers": {
    "luxembourgish-data-protection-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/luxembourgish-data-protection/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/luxembourgish-data-protection-mcp
```
...
```json
{
  "mcpServers": {
    "luxembourgish-data-protection-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/luxembourgish-data-protection-mcp"]
    }
  }
}
```
...
| Tool | Description |
|------|-------------|
| `lu_dp_search_decisions` | Full-text search across CNPD decisions (délibérations, sanctions, mises en demeure). Returns matching decisions with ... |
| `lu_dp_get_decision` | Get a specific CNPD decision by reference number (e.g., |
| `lu_dp_search_guidelines` | Search CNPD guidance documents: guides pratiques, recommandations on vidéosurveillance, cookies, sous-traitance, tran... |
| `lu_dp_get_guideline` | Get a specific CNPD guidance document by its database ID. |
| `lu_dp_list_topics` | List all covered data protection topics with French and English names. Use topic IDs to filter decisions and guidelines. |
| `lu_dp_about` | Return metadata about this MCP server: version, data source, coverage, and tool list. |
